...
아래 표는 5가지 주요 손동작(비전 패턴)과 팔레트 모드에서의 색상 선택 과정을 요약한 것입니다.  
각 동작은 LED 패턴 혹은 모드를 매핑해, 신호등 제어를 더욱 유연하고 편리하게 만듭니다.

### 1. 주요 손동작

| 비전         | 패턴 이미지                                                                                       | 설명                                                                     |
|:-------------|:--------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------|
| **Default**  | <img src="image/gesture_default.jpg" alt="Default" width="100"/>                                  | 손가락이 모두 모여 있는 상태. 기본 신호등 패턴 유지                        |
| **Emergency**| <img src="image/gesture_emergency.jpg" alt="Emergency" width="100"/>                              | 엄지·검지·중지를 펴고 약지·새끼를 접은 상태. 긴급 모드(적색 LED)로 전환     |
| **ThumbsUp** | <img src="image/gesture_thumbsup.jpg" alt="ThumbsUp" width="100"/>                                | 엄지만 위로 든 동작. 모든 LED를 동일 주기로 깜빡이게 하는 모드로 전환       |
| **ThumbsDown**| <img src="image/gesture_thumbsdown.jpg" alt="ThumbsDown" width="100"/>                          | 엄지만 아래로 향한 동작. 모든 LED가 꺼지는 모드로 전환                     |
| **Palette**  | <img src="image/gesture_palette.jpg" alt="Palette" width="100"/>                                  | 다섯 손가락을 펼쳐 팔레트 모드 진입. LED 색상·주기 조절 UI가 활성화됨         |
...
| 색상선택      | 패턴 이미지                                                 | 설명                                                                     |
|:-------------:|:-----------------------------------------------------------:|:-------------------------------------------------------------------------|
| **Red LED**   | <img src="image/palette_red.jpg" alt="Palette Red" width="100"/>    | 엄지·검지를 빨간 원 위에 동시에 위치 → 빨간 LED의 주기(또는 밝기) 조절         |
| **Yellow LED**| <img src="image/palette_yellow.jpg" alt="Palette Yellow" width="100"/>| 엄지·검지를 노란 원 위에 동시에 위치 → 노랑 LED의 주기(또는 밝기) 조절         |
| **Green LED** | <img src="image/palette_green.jpg" alt="Palette Green" width="100"/> | 엄지·검지를 초록 원 위에 동시에 위치 → 초록 LED의 주기(또는 밝기) 조절         |

> **팁**  
> 팔레트 모드에서 **색상 원 안에 손가락을 약 750ms 이상 유지**하면,  
> 손가락 사이 거리(`fingerDistance`)를 바탕으로 **`signalPeriod`**나 **LED 밝기**를  
> **실시간**으로 조절할 수 있습니다.  
